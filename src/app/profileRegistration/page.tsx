    ...
    <div className="min-h-screen flex items-center justify-center bg-pastelBlue">
      ...
      >
        ...
        <div className="flex justify-between">
          <button
            type="submit"
            className="bg-pastelPink text-white p-3 rounded flex-grow flex-basis hover:scale-105 hover:shadow-lg"
          ...
          <Link href="/profileDetail">
            <span
              className="bg-pastelPink text-white p-3 rounded flex-grow flex-basis text-center cursor-pointer flex items-center justify-center hover:scale-105 hover:shadow-lg"
